...
export class Tuple3<T1, T2, T3> implements Ord<Tuple3<T1, T2, T3>> {
...
export class Tuple4<T1, T2, T3, T4> implements Ord<Tuple4<T1, T2, T3, T4>> {
...
export class Tuple5<T1, T2, T3, T4, T5> implements Ord<Tuple5<T1, T2, T3, T4, T5>> {
...
export class Tuple6<T1, T2, T3, T4, T5, T6> implements Ord<Tuple6<T1, T2, T3, T4, T5, T6>> {
...
export class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Ord<Tuple7<T1, T2, T3, T4, T5, T6, T7>> {
...
export class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> implements Ord<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> {
...
export class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Ord<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
...
export class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Ord<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {
